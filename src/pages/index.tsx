    ...
    <>
      ...
      <Grid pt="lg">
        <Grid.Col span={{ xs: 12, sm: 6 }}>
          <FeatureCard
            icon={FaBolt}
            title="Incredibly fast UI"
            tagline="No need to worry about spotty/slow wifi coverage."
          />
        </Grid.Col>
        <Grid.Col span={{ xs: 12, sm: 6 }}>
          <FeatureCard
        ...
        <Grid.Col span={{ xs: 12, sm: 6 }}>
          <FeatureCard
            ...
            tagline="Work with what you already have, no need to add another point of failure to your system."
          />{" "}
        </Grid.Col>
        <Grid.Col span={{ xs: 12, sm: 6 }}>
          <FeatureCard
            icon={FaMoneyBill1}
            title="Pay proportionality"
            tagline="Pay based on your business size, dont get stuck paying for more than you need."
          />{" "}
        </Grid.Col>
      </Grid>
    </>
